...
namespace HelpDesk_Sistemas.Interfaces
{
    public interface ITicketsRepository
    {
        ...
        Task<List<CatalogoModel>> ObtenerCategorias();
        Task<List<CatalogoModel>> ObtenerEstados();
        //Task<List<CatalogoModel>> ObtenerPersonalSolicitante();
        ...
        Task GuardarAdjunto(int idTicket, string nombreArchivo, string rutaArchivo, int pesoKB, int idUsuarioSube, string origen = "Solicitud");
